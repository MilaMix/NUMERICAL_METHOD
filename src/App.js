        ...
        <Layout>
          <Header className="header" style={{ backgroundColor: "#D6EAF8", height: "120px" }}>
            <div className="headertext">
              <label><PieChartOutlined style={{ color: "#1A5276", fontSize: "40px", marginRight: "10px" }} /><h2 style={{ color: "#1A5276" }}>Numerical Method</h2></label>
            </div>
          </Header>
          <Layout>
          ...
          <Footer style={{ backgroundColor: "#EBF5FB", minHeight: 120 }}>
